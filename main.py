...
WEBHOOK_HOST = '45.87.0.215'  # Domain name or IP addres which your bot is located.
...
WEBHOOK_SSL_CERT = './cert.srt'  # Path to the ssl certificate
WEBHOOK_SSL_PRIV = './cert.key'  # Path to the ssl private key
