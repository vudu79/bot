...
# TOKEN = '5751022934:AAGl3ExhyWaYIZXD_LBlShg_z0UO_oZ6uZ4'

WEBHOOK_HOST = 'tibidoh.ru'  # Domain name or IP addres which your bot is located.
...
WEBHOOK_SSL_CERT = '/home/andrey/python/selenium_test/sert/url_cert.pem'  # Path to the ssl certificate
WEBHOOK_SSL_PRIV = '/home/andrey/python/selenium_test/sert/url_pkey.pem'  # Path to the ssl private key
